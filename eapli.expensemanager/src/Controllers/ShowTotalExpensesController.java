...
public class ShowTotalExpensesController {
    ...
    /**
     * Retorna uma lista de despesas, de determinado mes e ano, agrupadas por
     * tipo de despesa
     *
     * @param month
     * @param year
    ...
    public List<ExpensesperMonthDTO> showExpensesByType(int month, int year) {
        IExpenseRepository eRepository =
                PersistenceFactory.getInstance().buildRepositoryFactory().getExpenseRepository();
        IExpenseTypeRepository eType =
                PersistenceFactory.getInstance().buildRepositoryFactory().getExpenseTypeRepository();
